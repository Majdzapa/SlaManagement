...
public class SlaConfiguration {
    ...
    public List<SlaRule> getRules() { return rules; }
    public void setRules(List<SlaRule> rules) { this.rules = rules; }
    public List<SlaResultMapping> getResultMappings() { return resultMappings; }
    public void setResultMappings(List<SlaResultMapping> resultMappings) { this.resultMappings = resultMappings; }
}
